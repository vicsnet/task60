const handleSubmit = (e) => {
  ...
  if (
    JSON.parse(localStorage.getItem("users")).some((data) => data.size == 1 && data.space == 1)
  ) {
  ...
  if (
    JSON.parse(localStorage.getItem("users")).some((data) => data.size == 1 && data.space == 2)
  ) {
    document.getElementById("text2").innerHTML = "Booked";
    document.getElementById("my1").style.backgroundColor = "lightblue";
  }
  if (
    JSON.parse(localStorage.getItem("users")).some((data) => data.size == 1 && data.space == 3)
  ) {
